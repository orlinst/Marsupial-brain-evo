...
###
# ??2	Rate of stochastic evolution (one parameter per trait)
# ??	Rate of adaptation to optima (one parameter per trait)
# t 1/2	Expected time to evolve halfway to an optimum; log(2)/??
# ??	Optimum trait value (one parameter per regime per trait)
...
# ???k	k ??? k', the reduction in complexity of the adaptive landscape when accounting for convergence
# ???k/k	Relative reduction in complexity of the adaptive landscape when accounting for convergence
